...
// FIX: Update component to accept a className prop to allow for flexible styling and fix typing errors when using React.cloneElement.
export const AiIcon: React.FC<{ className?: string }> = ({ className = "h-6 w-6" }) => (
...
// FIX: Update component to accept a className prop to allow for flexible styling and fix typing errors when using React.cloneElement.
export const AutomationIcon: React.FC<{ className?: string }> = ({ className = "h-6 w-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
// FIX: Update component to accept a className prop to allow for flexible styling and fix typing errors when using React.cloneElement.
export const WebDevIcon: React.FC<{ className?: string }> = ({ className = "h-6 w-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
// FIX: Update component to accept a className prop to allow for flexible styling and fix typing errors when using React.cloneElement.
export const DataScienceIcon: React.FC<{ className?: string }> = ({ className = "h-6 w-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 7v10m16-10v10M8 7v10m8-10v10m-4-6h.01M12 7h.01M12 17h.01" />
